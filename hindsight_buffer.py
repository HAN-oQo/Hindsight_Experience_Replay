...
"""
Replay Buffer for Hindsignt Experience Replay
"""
class HindSightReplayBuffer():
    ...
    def put(self, state, action, reward, state_, done, goal):
    ...
    def batch_to_device(mini_batch, device):
        ...
        goal = torch.tensor(goal).to(device).float()
        return s, a, r, s_prime, done, goal
